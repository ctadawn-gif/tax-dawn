  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <nav className="flex justify-between items-center px-6 lg:px-20 py-5 max-w-[1440px] mx-auto bg-white relative z-20">
        ...
        <a href="https://m.expert.naver.com/expert/profile/home?storeId=100055567&u=pPfkLxZfCoZXp4gZwIn7Gwh13UsHEXKuynJIyvXjZ5A%3D" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-md text-sm font-semibold bg-brand-navy text-white hover:bg-black transition-colors shadow-sm">상담 예약하기</a>
      </nav>
