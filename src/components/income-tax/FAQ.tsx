...
const QNA = [
  {
    q: "저도 종합소득세 신고 대상인가요?",
    a: "프리랜서(3.3% 원천징수)든 개인사업자든, 2025년에 1원이라도 사업소득이 있으면 신고 대상입니다. 근로소득만 있어도 2개 이상 회사에서 급여를 받았거나, 이자·배당 2천만 원 초과, 기타소득 3백만 원 초과 등에 해당하면 합산신고해야 합니다. 애매하시면 편하게 문의 주세요.",
  },
  {
